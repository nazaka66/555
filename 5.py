...
def bot(op):
    ...
    #--------------- SC Add Admin ---------
            ...
            elif msg.text in ["Adminlist","แอดมินบอท"]:
              if admin == []:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"สถานะ url เปิด")
                    else:
                        random.choice(KAC).sendText(msg.to,"สถานะ url เปิด")
                else:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).updateGroup(X)
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"สถานะ url ปิด")
                    else:
                        random.choice(KAC).sendText(msg.to,"สถานะ url ปิด")
                else:
                    if wait["lang"] == "JP":
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
            ...
            elif msg.text in ["เบื่อบอท","Wkwk","Wk","wkwkwk","wkwk","wk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki.sendMessage(msg)
                #kk.sendMessage(msg)
            elif msg.text in ["555","555+","5555","อิอิ","hehe","he"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                #kk.sendMessage(msg)
            elif msg.text in ["อะไร","มันคืออะไร"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "110",
                ...
                ki.sendMessage(msg)
                #kk.sendMessage(msg)
            elif msg.text in ["อืม","เออ","ใช่","hmmm","hmm","hm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
                                     ...
                                     "STKVER": "100" }
                ki.sendMessage(msg)
            elif msg.text in ["Welcome","มาใหม่","คนใหม่"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "247",
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"สถานะ QR = On")
                    else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["Protectgr"] = True
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"สถานะ QR = Off")
                    else:
                        cl.sendText(msg.to,"done")
                else:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["กรู๊...","binla:on","Binla:On"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            ...
            elif msg.text in ["botgohome"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#----------------------------- TAG ALL MEMBER -------------------------------
            if msg.text.lower() in ["@@@@"]:
                ...
                cnt = Message()
                cnt.text = "อะโต้ยยยย  : " + str(jml) +  "Member"
                cnt.to = msg.to
                cl.sendMessage(cnt)
#-------------------------------------------------------------------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'uf554c97bcf3bb0e0f7f642012575c520'}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                    for g in gs.members:
